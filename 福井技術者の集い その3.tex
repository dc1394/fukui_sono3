...
%TCIDATA{Created=Wednesday, April 08, 2015 13:02:00}
%TCIDATA{LastRevised=Saturday, May 02, 2015 13:23:01}
...
\begin{tabular}
[c]{ll}%
$4\pi r^{2}R_{nl}^{2}\left(  r\right)  \left[  \operatorname{Re}Y_{lm}\left(
\theta,\phi\right)  \right]  ^{2}$ & $\left(  m\geq0\right)  $\\
$4\pi r^{2}R_{nl}^{2}\left(  r\right)  \left[  \operatorname{Im}Y_{lm}\left(
